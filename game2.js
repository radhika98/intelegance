var snake, apple, squareSize, score, speed,
    ...
    textStyle_Key, textStyle_Value, randomText, text, xPos, yPos, i;

var game =  new Phaser.Game(800, 600, Phaser.CANVAS, 'gamebox2',{
    ...
    create : function() {
        ...
        //description 
        game.add.text(30,55, "Collect each name using your cursor keys to add to the list which creates an array!!", textStyle_Key);
        
        game.add.text(30,80, "Here's your list:", textStyle_Key);
...
appleCollision: function() {
    ...
    for(var i = 0; i < snake.length; i++){
        if(snake[i].x == apple.x && snake[i].y == apple.y){
            ...
            apple.destroy();
            name1TextValue.destroy();
  

//            names_eaten = []; 
            names_eaten.push(text[randomText]); 
            xPos = 30; 
            yPos = 90; 
            for (var i = 0; i < names_eaten.length; i++){
                yPos = yPos+20;
                game.add.text(xPos,yPos, names_eaten[i], textStyle_Value);
            }
...
wallCollision: function(head) {
    ...
    generateApple: function(){
        ...
        apple = game.add.sprite(randomX, randomY, 'apple');
         ...
         text = ["Radhika","Kelsey","Elaine","Nia"];
         randomText = Math.floor(Math.random()*4);
        name1TextValue = game.add.text(randomX+10,randomY+5, text[randomText], textStyle_Value);

//HI RADHIKA THIS IS ELAINE
